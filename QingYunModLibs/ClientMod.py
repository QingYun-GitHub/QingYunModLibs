...
def SetTimerTime(Timer, Time, Keep=False, Now=False):
    """
    动态修改延时器时间
...
def _AddCall(BaseCompObj, ForAllMod, obj):
    ...
    CallBack(Func, playerId, ForAllMod)
...
print "\n%s[QyMod] ClientMod加载完毕" % Bcolors.SUC